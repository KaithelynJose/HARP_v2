...
def page(arg):
    ...
    h.labelTitle = sn(**{ ## gui.entry(arg,"style","align","text", name="entryName" ,password=True, keyboard=True, type=number),
        "obj": gui.label(arg,"labelTitle","left","Record:", name="labelTitle"),
        "pos": sn(**{
    ...
    h.ascii = sn(**{ ## gui.entry(arg,"style","align","text", name="entryName" ,password=True, keyboard=True, type=number),
        "obj": gui.listbox(arg,data=[], name="ascii", orient="horizontal"),
        "pos": sn(**{
            "x": 50,
            "y": 100,
            "w": 700,
    ...
    h.btnBack = sn(**{ ## gui.entry(arg,"style","align","text", name="entryName" ,password=True, keyboard=True, type=number),
        "obj": gui.button(arg,"button","center","BACK", lambda: arg.fcn_record.back(arg)),
        "pos": sn(**{
            "x": 600,
            "y": 400,
            "w": 150,
